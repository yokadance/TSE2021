...
@Named("MenuPostBean")
@SessionScoped
public class MenuPostBean implements Serializable {
  ...
  public String test() {
    ...
    clear();
    return "menuPost?faces-redirect=true?includeViewParams=true&centerId=" + cId;
  }
//  public String back() {
//    Long pId = getPlanId();
//    clear();
...
//  }
  ...
  public void save() throws IOException, ParseException {
    ...
    Faces.redirect("menuPost.jsf?centerId=" + centerId);
  }
