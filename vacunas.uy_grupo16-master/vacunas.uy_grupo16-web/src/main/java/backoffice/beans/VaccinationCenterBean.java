...
@Named("VaccinationCenterBean")
@SessionScoped
public class VaccinationCenterBean implements Serializable {
  ...
  public void save() throws IOException, ParseException {
    ...
    if (getId() == null) {
      newVCenterId = iVaccinationCenterController.saveVaccinationCenter(d);
    ...
    Faces.redirect("vaccinationCenter.jsf?planId=" + planId);
  }
  ...
  private void catchData() {
    try {
      Long i = getPlanId();
      listDTVaccinationCenters = iVaccinationCenterController.getCentersByPlan(i);
  ...
  public String remCenters() throws IOException {
    try {
      for (DTVaccinationCenter l : selectedVaccinationCenters) {
        iVaccinationCenterController.unassignVaccinationCenter(l.getId(), planId);
      }
    } catch (Exception e) {
      return e.getMessage();
    }
