...
a persistence unit "vacunas.uy_grupo16PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "vacunas.uy_grupo16\pom.xml":
...
artifacts ("vacunas.uy_grupo16-ejb.jar" and "vacunas.uy_grupo16-web.war") are already built. You can build
