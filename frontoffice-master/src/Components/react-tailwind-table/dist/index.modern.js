  ...
  var Table = /*#__PURE__*/ (function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      return React.createElement(
        'div',
        {
          className: 'pb-4 px-4 rounded-md w-full', //GSM ACA CAMBIEN
        },
        React.createElement(
          'div',
          {
              ...
              React.createElement(
                ...
                display_columns.map(function (column, index) {
                  return React.createElement(
                    ...
                    {
                      key: index.toString(),
                      className: 'px-4 py-2 text-denim-555',
                      style: {
                        // backgroundColor: '#75AFD6',
                        // opacity: 0.6,
                      },
                    },
                    column.use,
...
function SearchForm(props) {
  return React.createElement(
    'div',
    {
      className: 'w-full flex justify-end px-2 mt-2',
    },
    React.createElement(
      'div',
      {
