...
export class MeetingItem extends Component {
  render() {
    ...
    const subject =
      this.props.subject.substring(0, this.props.subjectLimit) +
      (this.props.subject.length > this.props.subjectLimit ? '...' : '')
      ...
      >
        ...
        <div className="rce-mtitem">
          <div className="rce-mtitem-top">
            ...
            <div className="rce-mtitem-share" onClick={this.props.onShareClick}>
              <MdLink />
            </div>
          </div>
          <div className="rce-mtitem-body">
            <div className="rce-mtitem-body--avatars">
              {this.props.avatars.slice(0, AVATAR_LIMIT).map((x, i) =>
                x instanceof Avatar ? (
                  x
                ) : (
                  <Avatar
