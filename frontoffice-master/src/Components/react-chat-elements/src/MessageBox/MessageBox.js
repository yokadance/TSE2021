      ...
      >
        ...
        {this.props.type === 'system' ? (
          ...
          >
            ...
            >
              {!this.props.retracted && this.props.forwarded === true && (
                <div
                  className={classNames(
                    'rce-mbox-forward',
                    {
              ...
              {!this.props.retracted && this.props.replyButton === true && (
                <div
                  className={
              ...
              {!this.props.retracted && this.props.removeButton === true && (
                <div
                  className={
                    this.props.forwarded === true
                      ? classNames(
              ...
              >
                ...
                {this.props.status && (
                  <span className="rce-mbox-status">
                    {this.props.status === 'waiting' && <IoIosTime />}

                    {this.props.status === 'sent' && <MdCheck />}

                    {this.props.status === 'received' && <MdDone />}

                    {this.props.status === 'read' && <MdDone color="#4FC3F7" />}
                  </span>
                )}
              </div>
            </div>
